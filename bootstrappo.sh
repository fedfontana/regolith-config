...
# riorganizzare la roba mettendola in modo più efficiente
# creare un altro script per installare la roba non necessaria, lasciare qua solo le robe indispensabil# Aggiungere echo per spiegare cosa succede / mettere prompt
